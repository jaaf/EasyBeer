...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.choose_edit = QtWidgets.QLineEdit(Form)
        self.choose_edit.setMaximumSize(QtCore.QSize(400, 16777215))
        font = QtGui.QFont()
        font.setFamily("FreeSans")
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.choose_edit.setFont(font)
        self.choose_edit.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.choose_edit.setObjectName("choose_edit")
        self.gridLayout.addWidget(self.choose_edit, 0, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.choose_edit.setText(_translate("Form", "Choose a rest beside"))
