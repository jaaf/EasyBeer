...
class Documentation(object):
    ...
    text=''''
<h1>Welcome to EasyBeer. What you should definitely read about this software?</h1>    
<h2>Introduction</h2>
...
database for all your ingredients, malts, hops, adjuncts and yeast.</p>
...
<p>It is a good starting point to use the dialogs that permit you to create these
 ...
 <ol>
 <li>Use the Database dialogs to declare your malts, hops, yeast, etc.</li>
 <li>Use the Database dialogs to declare your equipments</li>
 <li>Use the Database dialogs to declare your recipe</li>
...
<li>Some inputs may have a tool tip you make appear hovering it
</ul>

<h1>Opening the database dialogs</h1>
...
<p>In general, recipes are based on quantities to make a given batch volume. In EasyBeer, recipes are based on percentage. That means that these recipes
...
<li> 1 kg of malt2</li> 
 ...
 <p>you should declare:</p>
 <ul>
<li> 6/7=86% of malt1</li>
<li> 1/7=14 % of malt2</li> 
</ul>
<p>Be sure that the total of percentages is 100, otherwise you wil no be allowed to save the recipe.</p>
...
gravity and the different volumes. This inputs are only informative and for memory.</p>
 ...
 <p>EasyBeer’s graphical interface can be translated in various languages.
