...
class MaltDialog(QWidget,MaltDialogUI.Ui_MaltDialog ):
    ...
    def __init__(self,model,controller,util):
        ...
        self.model.subscribe_model_changed(['malt'],self.on_model_changed)
    ...
    def create(self):
        self.add_button.setText(self.tr('Add this new malt'))
        self.clear_edits()
        self.set_editable()
    ...
    def edit(self):
        self.add_button.setText(self.tr('Update this malt'))
        self.set_editable()
        self.set_editable_style()
        self.add_button.show()   
